...
import { crearTabla, obtenerSala, obtenerDueloActivo, obtenerHistorial, expirarDuelos } from '@/lib/dao/dueloDAO'
...
export default async function ArenaPage() {
  ...
  const [usuario, sala, activo, historial, coleccion] = await Promise.all([
